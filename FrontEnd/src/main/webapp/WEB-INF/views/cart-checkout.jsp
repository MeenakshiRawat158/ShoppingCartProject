...
<div class="container wrapper">
            ...
            <div class="row cart-body">
                <form class="form-horizontal" method="post" action="${pageContext.servletContext.contextPath}/checkout_complete">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6" style="color:black">
                    <!--REVIEW ORDER-->
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            Review Order <div class="pull-right"><small><a class="afix-1" href="${pageContext.request.contextPath}/myCart">Edit Cart</a></small></div>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12">${myCart.product_name}</div>
                                    <div class="col-xs-12"><small>Quantity:<span>1</span></small></div>
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>&#x20b9;</span>${myCart.price}</h6>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12"><input type="text"  required name="phone_number" class="form-control" value="" /></div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12"><strong>Email Address:</strong></div>
                                <div class="col-md-12"><input type="email" required name="email_address" class="form-control" value="" /></div>
                            </div>
